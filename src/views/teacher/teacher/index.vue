    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="角色" prop="role">
        <el-select v-model="queryParams.role" placeholder="请选择角色" clearable>
          <el-option
            v-for="dict in dict.type.teacher_role"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="teacherList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="角色" align="center" prop="role">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.teacher_role" :value="scope.row.role"/>
        </template>
      </el-table-column>
...
export default {
  name: "Teacher",
  dicts: ['teacher_role', 'is_using', 'teaching_group', 'sys_user_sex'],
  data() {
    return {
      // 遮罩层
      loading: true,
